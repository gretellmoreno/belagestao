-- Corrigir a função finalize_appointment para usar a coluna fee em vez de fee_percentage
...
BEGIN
    ...
    WITH updated_services AS (
        ...
        SET 
            -- Calcular valores financeiros para cada serviço usando fee em vez de fee_percentage
